...
meta_description: "Dance floor rentals in West Vancouver — 12×12, 12×12, 16×16 portable floors with subfloor for terraced lawns. Delivered and crew-installed. 212+ reviews."
...
![Two people dancing at a wedding reception](/images/lifestyle/dance-floor-2.jpg){.float-right}
*A reception dance floor in motion at a West Van estate.*
...
Subfloor on most installs. The boulevard and lawn-side seawall reception sites are flatter than British Properties but still irregular enough that the dance floor needs levelling. Salt-spray exposure means we tarp the panel staging area during longer setups.
...
Existing flooring, no subfloor, edge ramps only. Fast install, fast teardown.
...
The default West Van outdoor install pattern is: arrive at low-tide or pre-event window, lay subfloor panels with grade compensation (more panel underneath where the lawn drops away), lock the dance floor on top of the levelled subfloor surface, and install edge ramps on all four sides. The added install time isn't an upsell — it's the only way to deliver a floor that holds together for 80–100 dancing guests at midnight on an irregular West Van lawn. We don't quote a dance floor without subfloor for outdoor West Van bookings unless the surface is genuinely level (rooftop, paved patio, existing indoor floor). The [Lower Mainland tent size guide](/blog/tent-size-guide-lower-mainland-wedding) covers the marquee sizing the dance floor sits inside; the levelling math is what's West Van-specific.

## A 100-guest West Vancouver dance floor rental order
