/*!
 * qrcode-generator v1.4.4 — QR Code Generator for JavaScript
 * Copyright (c) 2009 Kazuhiko Arase (https://github.com/kazuhikoarase/qrcode-generator)
 * Licensed under the MIT license: https://opensource.org/licenses/MIT
 * The word "QR Code" is a registered trademark of DENSO WAVE INCORPORATED.
 *
 * Vendored for the Forever Party Rentals event-layout planner from
 * https://cdn.jsdelivr.net/npm/qrcode-generator@1.4.4/qrcode.min.js
 * (jsDelivr auto-minified UMD build of /qrcode.js). Global symbol: `qrcode`.
 * Usage: var qr = qrcode(0, 'M'); qr.addData(url); qr.make();
